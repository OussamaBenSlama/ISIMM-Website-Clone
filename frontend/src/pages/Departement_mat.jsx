...
import Header from '../components/departement/Header_math'
import Departement from '../components/departement/departement_mat'
import Menu from '../components/Menu'

const Departement_mat = () => {
...
export default Departement_mat
